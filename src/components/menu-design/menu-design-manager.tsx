...
export const THEME_OPTIONS: readonly ThemeOption[] = [
  {
    id: "MODERN",
    name: "AdisyonEx Modern",
    category: "Standart & Dinamik",
    description: "Kategori sekmeli, modern ürün kartları ve akıcı sepet deneyimi sunan popüler varsayılan tasarım.",
    badgeText: "Önerilen · Varsayılan",
  ...
  },
  {
    ...
    features: [
      ...
      "Altın & Amber vurgulu fiyat etiketleri",
      "Serif tipografi ve gurme atmosfer",
      "Fine dining ve bistrolar için ideal",
    ],
    accentColor: "bg-amber-500",
    bgPreview: "from-amber-500/20 via-zinc-950 to-zinc-900",
  },
  {
    id: "MINIMAL_LIST",
    name: "Minimal Liste (Kafe & Bar)",
    category: "Sade & Hızlı",
    description: "Gereksiz detaylardan arındırılmış, tek bakışta tüm menüyü görmeyi sağlayan hızlı liste düzeni.",
    badgeText: "Hızlı Tarama",
    badgeColor: "bg-slate-500/15 text-slate-700 dark:text-slate-300 border-slate-500/30",
    features: [
      "Ultra hızlı ve hafif liste formatı",
      "Kompakt satır içi fiyatlandırma",
      "Düşük internet tüketimi",
      "Kahve dükkanları ve barlar için kusursuz",
    ],
