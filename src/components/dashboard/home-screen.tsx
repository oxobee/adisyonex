  ...
  return (
    <main className="relative min-h-[calc(100vh-3.5rem)] w-full overflow-x-hidden bg-gradient-to-b from-[#181a20] via-[#0e0f13] to-[#07080a] text-white flex flex-col justify-between select-none">
      {/* 
        ...
        Deep charcoal & graphite gradient with overhead spotlight
      */}
      ...
      */}
      ...
      {/* 
        MAIN CENTER STAGE:
        "logo ve buton ortalı olsun logo daha büyük olsun"
        - Hem Logo hem Buton sayfaya yatay ve dikey olarak kusursuz ORTALIDIR.
        - Logo belirgin şekilde çok daha büyüktür.
        - Menü tıklandığında butonun altında kartlar sıfır çakışmayla elastik açılır.
      */}
      <div className="relative z-20 flex-1 flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 w-full max-w-7xl mx-auto">
        {/* 
          ORTALANMIŞ BÜYÜK LOGO VE BUTON
        */}
        <div
          className={cn(
            "flex flex-col items-center justify-center text-center select-none w-full transition-all duration-500 ease-out",
            isOpen ? "pt-2 sm:pt-4 pb-6" : "py-12 sm:py-20 my-auto",
          )}
        >
          {/* ÇOK DAHA BÜYÜK BEYAZ SİSTEM LOGOSU */}
          ...
          {/* 
            LOGONUN ALTINDA: ORTALANMIŞ "MENÜ / KAPAT" BUTONU
          */}
          <div className="mt-6 sm:mt-8">
            <button
              ...
              className={cn(
                "group relative inline-flex items-center justify-center gap-2.5 px-9 sm:px-12 py-3.5 sm:py-4 rounded-full font-black text-xs sm:text-sm tracking-widest uppercase transition-all duration-300 cursor-pointer outline-none select-none active:scale-95 shadow-2xl",
                isOpen
                  ? "bg-white text-zinc-950 hover:bg-zinc-100 border-2 border-white shadow-[0_0_40px_rgba(255,255,255,0.45)]"
        ...
        {/* 
          ...
          - Sıfır çakışma (her kart bağımsız alanda)
